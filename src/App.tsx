...
function App() {
  const [accountInitVal, setAccountInitVal] = useState<number>(100000)
    ...
    <div className="App">
      ...
      <div className="flex flex-wrap justify-evenly">
        <section>
          <aside className="bg-white rounded-md shadow-md text-left text-slate-700">
            ...
            <ul className="list-none p-0">
              <li className="py-3 px-5">BRL: {accountInitVal.toLocaleString('pt-br', { style: 'currency', currency: 'BRL' })}</li>
        ...
        <main className="w-2/4 py-4 px-8 bg-white rounded-md shadow-md text-slate-700 text-left">
          ...
          <Form accountInitVal={accountInitVal} />
        </main>
      </div>
    </div>
  );
