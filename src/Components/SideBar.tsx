    ...
    <section>
      <aside className="bg-white rounded-md shadow-md text-left text-slate-700">
        ...
        <ul className="list-none p-0">
          <li className="flex justify-between py-3 px-5">BRL: <div>{wallet[lastIndex].balance.toLocaleString('pt-br', { style: 'currency', currency: 'BRL' })}</div></li>
          <li className="flex justify-between py-3 px-5">BTC:  <div>฿ {wallet[lastIndex].btc.toFixed(6)}</div></li>
          <li className="flex justify-between pt-3 pb-8 px-5">BUSD: <div>$ {wallet[lastIndex].busd.toFixed(3)}</div></li>
